					...
					<div class="col-md-12 col-lg-6 mb-4">
						<div class="d-flex rounded shadow">
							...
							<div class="w-50 bg-white rounded-right p-4">
								<h5>{{ $product->name }}</h5>
								<p class="mb-3 d-none d-md-block">{{  strip_tags($product->description) }}</p>
						...
						<div class="modal-dialog modal-dialog-centered modal-xl">
							<div class="modal-content border-0 shadow-lg">
								<div class="row">
									...
									<div class="col-lg-7 col-xl-8 rounded-right" style="background-image: url({{ $product->getFirstMediaUrl('images', 'modal_images') }});">
